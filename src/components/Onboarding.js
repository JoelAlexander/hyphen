...
const UniquePassphrase = ({ noBalance, fingerprint, forgetFingerprint, inviteCode, createWallet, setWallet }) => {
    ...
    <div className="onboarding-container">
      ...
      {step !== 'splash' &&
        <div className="onboarding-content">
          ...
          {step === 'uniquePassphrase' && <UniquePassphrase noBalance={noBalance} fingerprint={fingerprint} forgetFingerprint={confirmForgetFingerprint} inviteCode={inviteCode} createWallet={createWallet} setWallet={setWallet} />}
